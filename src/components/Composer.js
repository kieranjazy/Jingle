...
function Composer() {
    ...
    this.loadedInstruments = [
        { "name": "01_synth_lead", "isLoaded": true, "type": "wavetable" }, //maybe change false
        { "name": "02_synth_lead", "isLoaded": true, "type": "wavetable" },
        { "name": "03_synth_lead", "isLoaded": true, "type": "wavetable" },
        { "name": "04_synth_lead", "isLoaded": true, "type": "wavetable" }
    ];
...
Composer.prototype.__record = async function (trackNum) {
    ...
    let prevNotes = [];
    let totalTrackLength = (30 / this.bps) * 32; //Total Track Length is how many notes you can fit in 30s
